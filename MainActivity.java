...
public class MainActivity extends AppCompatActivity {
    ...
    private TextToSpeech initTextToSpeechService(){
        ...
        service.setUsernameAndPassword(getString(R.string.watson_tts_username),getString(R.string.watson_tts_password));
        return service;
    }
    ...
    private void addMessageFromUser(ConversationMessage message) {
        ...
        if (message.getUser().equals(USER_WATSON)) {
            ...
            new WatsonTask().execute(message.getMessageText());    //Call the method WatsonTask to invoke Text to Speech API
        } else {
    ...
    */
    ...
    private class WatsonTask extends AsyncTask<String, Void, String> {
        ...
        @Override
        protected String doInBackground(String...texttoSpeech) {
